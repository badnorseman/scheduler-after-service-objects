...
module = angular.module('format-number', []);

module.directive('formatNumber', ['formatNumber',
  function(formatNumber) {
    ...
    defaultOptions = formatNumber.defaultOptions;
      ...
      link: function(scope, elem, attrs, ngModelCtrl) {
        ...
        ngModelCtrl.$parsers.unshift(function(viewVal) {
          ...
          if (isValid(noCommasVal) || !noCommasVal) {
            ngModelCtrl.$setValidity('formatNumber', true);
            return noCommasVal;
          } else {
            ngModelCtrl.$setValidity('formatNumber', false);
            return void 0;
          }
        });
...
module.provider('formatNumber', function() {
  var _defaultOptions;
  _defaultOptions = {};
